...
5. Load all steps from `construction/code-generation.md`
6. **PART 1 - Planning**: Create code generation plan with checkboxes, get user approval
7. **PART 2 - Generation**: Execute approved plan to generate code for this unit
8. **MANDATORY**: Present standardized 2-option completion message as defined in code-generation.md - DO NOT use emergent behavior
